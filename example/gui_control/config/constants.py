...
_HAND_CONFIGS: Dict[str, HandConfig] = {
    ...
    "L20": HandConfig(
        ...
        #陆稍微修改了一下
        #可以依次按照顺序执行，但是顺序不能发，四回不到二，三回不到一，因为拇指在下面，到位置就停了，而无名指小指还在上面
        # 如果四想回到二，首先可以先回到点赞，即回到二的上级，然后再回到二
        preset_actions={
            "握拳": [60, 0, 0, 0, 0, 167, 10, 100, 180, 240, 19, 255, 255, 255, 255, 142, 0, 0, 0, 0],
            "张开": [255, 255, 255, 255, 255, 255, 10, 100, 180, 240, 245, 255, 255, 255, 255, 255, 255, 255, 255, 255],
            "OK": [191, 95, 255, 255, 255, 136, 107, 100, 180, 240, 100, 255, 255, 255, 255, 116, 99, 255, 255, 255],
            ...
            "壹": [59, 255, 0, 0, 0, 85, 125, 100, 180, 240, 19, 255, 255, 255, 255, 135, 255, 0, 0, 0],
            "贰": [40, 255, 255, 0, 0, 81, 35, 177, 180, 240, 19, 255, 255, 255, 255, 135, 255, 255, 0, 0],
            "叁": [105, 255, 255, 255, 0, 39, 62, 123, 180, 240, 0, 255, 255, 255, 255, 125, 255, 255, 255, 0],
            "肆": [95, 255, 255, 255, 255, 161, 62, 123, 180, 242, 13, 255, 255, 255, 255, 113, 255, 255, 255, 255],
            ...
            "漆": [81, 0, 0, 0, 0, 161, 10, 127, 180, 219, 18, 255, 255, 255, 255, 255, 195, 205, 0, 0],
            "捌": [255, 255, 0, 0, 0, 202, 104, 100, 180, 240, 233, 255, 255, 255, 255, 255, 255, 0, 0, 0],
            "玖": [40, 255, 0, 0, 0, 131, 103, 100, 180, 240, 19, 255, 255, 255, 255, 149, 47, 0, 0, 0],
            "蜘蛛侠":[255, 255, 0, 0, 255, 128, 10, 100, 180, 255, 255, 255, 255, 255, 255, 255, 255, 0, 0, 255]
        }
    ),
    "G20": HandConfig(
        joint_names=["拇指根部", "食指根部", "中指根部", "无名指根部", "小指根部",
